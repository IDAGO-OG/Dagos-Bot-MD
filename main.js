...
const connectionOptions = {
  ...
  browser: ['Dagos-Bot', 'Edge', '1.0.0'], // Cambiado a Dagos-Bot
  msgRetryCounterMap,
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ HASTA LA VISTA CHAVISTA INFELIZ, QUE TE VAYA BIEN EN EL INFIERNO 👋🏻* \n*╚══════════════*';
  conn.spromote = '*@user AHORA SUBIO SU ESTATUS EN EL GRUPO!!*';
  conn.sdemote = '*@user AHORA ES UN SIMPLE MORTAL!!*';
